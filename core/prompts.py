...
5.  **Interactivity:** Add subtle hover effects and transitions.
6.  **Content:** Create rich, elaborate, and unique content with high-quality placeholders.
...
SYSTEM_PROMPT_SURGICAL_EDIT = (
    ...
    "**CRITICAL MANDATES:**\n"
    "1.  **SCOPE:** You MUST apply the user's changes **ONLY** to the element marked with `data-neuro-edit-target=\"true\"` and its children. You are **STRICTLY FORBIDDEN** from modifying any other part of the document.\n"
    "2.  **STYLING:** All style changes **MUST** be made using inline Tailwind CSS classes. You are **STRICTLY FORBIDDEN** from adding any global `<style>` blocks or CSS that would affect other elements.\n"
